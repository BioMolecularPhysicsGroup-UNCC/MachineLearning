...
% ---------------------------------------------------- nonfunctional cases
               stdv0 = sqrt( var0(1:n0,j) );          % standard deviation
               aveMean0 = mean( ave0(1:n0,j) );
               minMean0 =  min( ave0(1:n0,j) );
               maxMean0 =  max( ave0(1:n0,j) );
              %--------------------------------------
...
% ------------------------------------------------------- functional cases
               stdv1 = sqrt( var1(1:n1,j) );          % standard deviation
               aveMean1 = mean( ave1(1:n1,j) ); 
               minMean1 =  min( ave1(1:n1,j) );
               maxMean1 =  max( ave1(1:n1,j) );
              %--------------------------------------
...
% ------------------------------------------- construct universal measures
               ...
               d = sigMeanMin*sqrt(1+r);         % normally: sqrt(1 + r^2)
               %               Note: ^---> less difficult criteria is used
               % Too difficult criteria can prevent a solution to nucleate
               % --------------------------------------- 4 scaled measures
