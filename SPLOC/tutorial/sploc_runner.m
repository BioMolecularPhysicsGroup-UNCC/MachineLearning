...
CovF_tr = getMultivariateStats4sploc(AmatrixF_tr,10,1,'cov');
CovN_tr = getMultivariateStats4sploc(AmatrixN_tr,10,1,'cov');

CovF_ts = getMultivariateStats4sploc(AmatrixF_ts,10,1,'cov');
CovN_ts = getMultivariateStats4sploc(AmatrixN_ts,10,1,'cov');
CovU_ts = getMultivariateStats4sploc(AmatrixU_ts,10,1,'cov');
...
if(do_save == 1)
    ...
    saveas(figure(100), 'ProjectionPlot', 'png');
    dlmwrite('DiscriminateModes.txt', U); 
end