...
disp('   ');
disp(logFile);
qTypeValue = 'hardLinear';  % ('hardLinear,'softGeometry','hybrid')
initializeSPLOC(1,'fName',logFile,'qType',qTypeValue,'gType','png');
initializeSPLOC(1,'fName',logFile,'qType',qTypeValue,'bType',-0.9,'gType','png');
